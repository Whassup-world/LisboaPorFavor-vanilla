...
1.0.1  Metadata Field           Prime 05 - Active Session
1.0.2  Title                    LBPF_PRIME_05_ACTIVE_SESSION.md
1.0.3  Version                  V1.0.0
1.0.4  Version History          2026-01-31: Initial creation from TOBE Prime structure
1.0.5  Date Modified            2026-01-31 @ 14.05 hour
1.0.6  Date Created             2026-01-31 @ 14.05 hour
1.0.7  File Type                MD
1.0.8  Tags                     prime, active-session, session-log, lbpf
1.0.9  Description              LBPF Active Session log - pointer to live session and session-end review rules
1.0.10 Source                   USER
1.0.11 Confidentiality Level    INTERNAL
1.0.12 Owner                    USER
1.0.13 Canonical path           lisboaporfavor-vanilla/docs/primes/LBPF_PRIME_05_ACTIVE_SESSION.md
