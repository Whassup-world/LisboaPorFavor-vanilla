...
1.0.1  Metadata Field           Core - Brainstorm
1.0.2  Title                    LBPF_BRAINSTORM.md
...
1.0.7  File Type                MD
1.0.8  Tags                     lbpf, brainstorm, ideas
1.0.9  Description              LBPF brainstorm intake (structured ideas; not executable until absorbed/approved)
1.0.10 Source                   USER
1.0.11 Confidentiality Level    INTERNAL
1.0.12 Owner                    USER
1.0.13 Canonical path           lisboaporfavor-vanilla/docs/core/LBPF_BRAINSTORM.md
